...
public class JwtProvider {
    ...
    public String createToken(UserDetails userDetails){
        ...
        claims.put("userID", ((AuthUserDetail) userDetails).getUserID()); // user permission
        claims.put("active", ((AuthUserDetail) userDetails).getActive());
        return Jwts.builder()
                .setClaims(claims)
    ...
    // username in this case, is the email
